...
namespace ProjectGame.Cards
{
    public class Card
    {
        ...
        {
            // TODO: ƒобавить вычисление динамических переменных
            // в зависимости от статов держател€ карты и наведЄнной цели
            ...
            // TODO: ¬ызывать метод у визуализатора карты и передавать уже готовое описание
        }
    }
}
